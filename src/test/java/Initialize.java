...
public class Initialize {
    ...
    public static void putMonsterCardsToBuy(HashMap<String, Integer> cardsToBuy) {
    ...
    public static void putSpellAndTrapCardsToBuy(HashMap<String, Integer> cardsToBuy) {
    ...
    public static void cardsSetNO60Appender(HashMap<String, Integer> cardsToAdd) {
